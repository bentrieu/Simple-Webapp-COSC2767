...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">Hello world for Trieu Hoang Khang!!!</h1>
      <p class="lead">
        This is a very simple website template that uses bootstrap CSS
        framework!
      </p>
      <p class="lead">
        This website is build automatically by Jenkins!!! Yeahhhh!!! Woohoooo!
      </p>
      <p class="lead">
        This sentence is a new feature and hopefully will trigger the Jenkins
        job to activate!
      </p>
      <hr class="my-4" />
      <p>
